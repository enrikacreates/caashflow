...
import { getBudgetPeriods, getMonthlyManualIncome } from '@/app/actions/periods'
...
export default async function InvoicesPage() {
  const [invoices, periods, settings, baseItems, manualByMonth] = await Promise.all([
    getInvoices(),
    getBudgetPeriods(),
    getSettings(),
    getBaseBudgetItems(),
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <CashFlowChart invoices={invoices} incomeGoal={settings.monthly_income_goal} expenseNeed={expenseNeed} periods={periods} manualByMonth={manualByMonth} />
